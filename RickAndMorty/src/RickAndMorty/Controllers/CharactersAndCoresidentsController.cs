...
namespace RickAndMorty
{
    [ApiController]
    [Route("[controller]")]
    public class CharactersAndCoresidentsController : ControllerBase
    {
        private readonly ILogger<CharactersAndCoresidentsController> _logger;
        private readonly ICharacterAndCoresidentsEngine _engine;

        public CharactersAndCoresidentsController(
            ILogger<CharactersAndCoresidentsController> logger,
            ICharacterAndCoresidentsEngine engine)
        {
            _logger = logger;
            _engine = engine;
        }
            ...
            [FromQuery(Name = "page")] int? page)
        {
            ...
            try
            {
                var engineResponse = await _engine.FindCharactersAndCoresidents(new FindCharactersRequest
                {
                    Name = name,
                    Status = status,
                    Species = species,
